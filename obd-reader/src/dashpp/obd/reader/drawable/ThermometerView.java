package dashpp.obd.reader.drawable;
...
public final class ThermometerView extends View {
	...
	private static final int minDegrees = -20;
	...
	private void initDrawingTools() {
		...
		faceTexture = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.white);
		...
		scalePaint.setColor(0x9f000000);
		...
		// changed logo
		logo = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.gauge);
		
		logoMatrix = new Matrix();
		logoScale = (1.0f / logo.getWidth()) * 0.55f;;
	...
	protected void onDraw(Canvas canvas) {
		...
		setHandTarget(dashpp.obd.reader.activity.AlertActivity.MONITOR);
